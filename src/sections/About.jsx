    ...
    <div className="min-h-screen bg-[#0A0F1C] relative py-20 px-4 md:px-8 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center mb-16">
          <h2 className="text-[#00A3FF] font-medium tracking-wider uppercase mb-2 animate-fade-in">Discover Our Story</h2>
          <h1 className="text-4xl md:text-6xl font-bold text-white mb-4 animate-slide-up">
            About <span className="bg-gradient-to-r from-[#00A3FF] to-[#00FFB2] text-transparent bg-clip-text">QuizBot</span>
          </h1>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="grid grid-cols-2 gap-4 animate-fade-in">
            <div className="bg-white/5 backdrop-blur-sm p-6 rounded-2xl transform hover:scale-105 transition-all duration-300 border border-white/10 group">
              ...
              <h3 className="text-white text-lg font-semibold mb-2">AI-Powered</h3>
              <p className="text-gray-400 text-sm">Smart quizzes tailored to your learning style</p>
            </div>
            ...
            <div className="bg-white/5 backdrop-blur-sm p-6 rounded-2xl transform hover:scale-105 transition-all duration-300 border border-white/10 group">
              ...
              <h3 className="text-white text-lg font-semibold mb-2">Instant Feedback</h3>
            ...
            <div className="bg-white/5 backdrop-blur-sm p-6 rounded-2xl transform hover:scale-105 transition-all duration-300 border border-white/10 group">
              ...
              <h3 className="text-white text-lg font-semibold mb-2">Wide Topics</h3>
              <p className="text-gray-400 text-sm">From academics to general knowledge</p>
            </div>
            ...
            <div className="bg-white/5 backdrop-blur-sm p-6 rounded-2xl transform hover:scale-105 transition-all duration-300 border border-white/10 group">
              ...
              <h3 className="text-white text-lg font-semibold mb-2">For Everyone</h3>
              <p className="text-gray-400 text-sm">Students, professionals & enthusiasts</p>
            </div>
          </div>
          ...
          <div className="text-white space-y-6 animate-fade-in">
            <div className="bg-white/5 backdrop-blur-sm p-8 rounded-2xl border border-white/10">
              <p className="text-gray-300 leading-relaxed mb-6">
                Welcome to QuizBot — your intelligent companion for personalized learning and self-improvement. Our AI-powered platform revolutionizes the way you learn and test your knowledge, making education more accessible, engaging, and effective than ever before.
              </p>
              <p className="text-gray-300 leading-relaxed mb-6">
                Whether you're preparing for exams, expanding your knowledge, or simply enjoying the thrill of learning, QuizBot adapts to your unique needs and learning style.
              </p>
              <CommonButton
                title="Explore More →"
